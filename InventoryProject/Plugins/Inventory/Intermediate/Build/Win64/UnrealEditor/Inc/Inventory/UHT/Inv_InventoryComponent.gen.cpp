...
struct Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics
{
	struct _Script_Inventory_eventInventoryItemChanged_Parms
	{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_Inventory_eventInventoryItemChanged_Parms, Item), Z_Construct_UClass_UInv_InventoryItem_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::NewProp_Item,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::PropPointers) < 2048);
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_Inventory, nullptr, "InventoryItemChanged__DelegateSignature", Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::PropPointers), sizeof(Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::_Script_Inventory_eventInventoryItemChanged_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::Function_MetaDataParams)},  };
static_assert(sizeof(Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::_Script_Inventory_eventInventoryItemChanged_Parms) < MAX_uint16);
UFunction* Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_Inventory_InventoryItemChanged__DelegateSignature_Statics::FuncParams);
	}
	return ReturnFunction;
}
void FInventoryItemChanged_DelegateWrapper(const FMulticastScriptDelegate& InventoryItemChanged, UInv_InventoryItem* Item)
{
	struct _Script_Inventory_eventInventoryItemChanged_Parms
	{
		UInv_InventoryItem* Item;
	};
	_Script_Inventory_eventInventoryItemChanged_Parms Parms;
	Parms.Item=Item;
	InventoryItemChanged.ProcessMulticastDelegate<UObject>(&Parms);
}
...
{
	UInv_ItemComponent* Item;
	int32 StackCount;
	int32 Remainder;
};
static FName NAME_UInv_InventoryComponent_Server_AddStacksToItem = FName(TEXT("Server_AddStacksToItem"));
void UInv_InventoryComponent::Server_AddStacksToItem(UInv_ItemComponent* Item, int32 StackCount, int32 Remainder)
{
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UInv_InventoryComponent_Server_AddStacksToItem_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(Inv_InventoryComponent_eventServer_AddStacksToItem_Parms, Item), Z_Construct_UClass_UInv_ItemComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Item_MetaData), NewProp_Item_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UInv_InventoryComponent_Server_AddStacksToItem_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UInv_InventoryComponent_Server_AddStacksToItem_Statics::NewProp_Item,
...
{
	P_GET_OBJECT(UInv_ItemComponent,Z_Param_Item);
	P_GET_PROPERTY(FIntProperty,Z_Param_StackCount);
	P_GET_PROPERTY(FIntProperty,Z_Param_Remainder);
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->Server_AddStacksToItem_Implementation(Z_Param_Item,Z_Param_StackCount,Z_Param_Remainder);
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UInv_InventoryComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UInv_InventoryComponent_Server_AddStacksToItem, "Server_AddStacksToItem" }, // 1795490917
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_harad_Documents_Unreal_Projects_InventoryPlugin_InventoryProject_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Components_Inv_InventoryComponent_h__Script_Inventory_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UInv_InventoryComponent, UInv_InventoryComponent::StaticClass, TEXT("UInv_InventoryComponent"), &Z_Registration_Info_UClass_UInv_InventoryComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInv_InventoryComponent), 3801169048U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_harad_Documents_Unreal_Projects_InventoryPlugin_InventoryProject_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Components_Inv_InventoryComponent_h__Script_Inventory_1476627564(TEXT("/Script/Inventory"),
	Z_CompiledInDeferFile_FID_Users_harad_Documents_Unreal_Projects_InventoryPlugin_InventoryProject_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Components_Inv_InventoryComponent_h__Script_Inventory_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_harad_Documents_Unreal_Projects_InventoryPlugin_InventoryProject_Plugins_Inventory_Source_Inventory_Public_InventoryManagement_Components_Inv_InventoryComponent_h__Script_Inventory_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
